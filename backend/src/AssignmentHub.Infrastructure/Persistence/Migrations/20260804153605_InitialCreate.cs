        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GradedByTeacherId = table.Column<Guid>(type: "uuid", nullable: false),
                    ...
                    PreviousMarks = table.Column<int>(type: "integer", nullable: true),
                    NewMarks = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GradeAuditLogs_Submissions_SubmissionId",
                        column: x => x.SubmissionId,
                        principalTable: "Submissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_GradeAuditLogs_Users_GradedByTeacherId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Assignments_ClassSubjectId_Status",
                table: "Assignments",
                columns: new[] { "ClassSubjectId", "Status" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeAuditLogs_GradedByTeacherId",
                table: "GradeAuditLogs",
                column: "GradedByTeacherId");

            migrationBuilder.CreateIndex(
                name: "IX_GradeAuditLogs_SubmissionId",
                table: "GradeAuditLogs",
                column: "SubmissionId");
